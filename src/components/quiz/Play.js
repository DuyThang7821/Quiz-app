            ...
            <Fragment>
                ...
                <div className="questions">
                    ...
                    <div className="timer-container">
                        <p>
                            <span className="left" style={{ float: 'left' }}>{currentQuestionIndex + 1} trên {numberOfQuestions}</span>
                    ...
                    <div className="button-container">
                        ...
                        <button id="quit-button" onClick={this.handleButtonClick}>Thoát</button>
                    </div>
                </div>
            </Fragment>
        );
